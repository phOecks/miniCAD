...
public class FrameCG extends JFrame {
	 ...
	 */
	 ...
	 private void acaoExecutada() {
		...
		rdbtnRetanguloBresenham.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	...
	private void initComponents() {
		...
		txtX3.setColumns(10);
		txtX3.setBounds(882, 218, 130, 26);
		contentPane.add(txtX3);
		txtX3.setVisible(false);
		
		txtY3 = new JTextField();
		txtY3.setColumns(10);
		txtY3.setBounds(882, 251, 130, 26);
		...
		lblMetodo = new JLabel("Selecione o metodo:");
